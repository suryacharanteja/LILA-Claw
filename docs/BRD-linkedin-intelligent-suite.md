...
| Approval of this revision | Approved, 7 September 2026; [approval record](approval-records/BRD-v1.1-approval.md) |
...
| Review snapshot | [BRD-v1.1.md](brd-versions/BRD-v1.1.md) |

The sponsor approved v1.1 on 7 September 2026. It is the current business baseline and supersedes v1.0.1. Both review snapshots remain intact. Requirement wording is unchanged; approval covers this reorganized document and its presentation of the agreed process.
...
| 1.1 reorganized BRD | Approved, 7 September 2026 | Sponsor: “BRD: Approved, go ahead for the next step”; separate approval record retained |
