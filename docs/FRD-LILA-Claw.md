...
Sponsor approved this document together with FD package v0.1. See the [approval record and preserved review package](approval-records/FRD-v0.3-approval.md). Review-time proposal/request wording below identifies what was approved; the complete package is now the functional baseline. Implementation validation and later-phase addenda remain outstanding as specified.
