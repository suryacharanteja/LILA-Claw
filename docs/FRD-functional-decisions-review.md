...
Version: 0.1  
Status: Approved with FRD v0.3 — see approval record  
Date: 7 September 2026  
Companion: FRD-LILA-001 v0.3

## Approval boundary

Sponsor approved this complete package with FRD v0.3; see the [approval record](approval-records/FRD-v0.3-approval.md). Proposal wording below is retained as context for the reviewed baseline, not an outstanding approval request.
